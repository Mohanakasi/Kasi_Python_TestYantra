...
#         v =_visibility_of_element_located(locat_)
#         wait.until(v)
...
# def click_element(locator):  #locator--->("class name","ico-register")
#     driver.find_element(*locator).click() #---> *locator---> "class name","ico-register"
#
# def enter_text(locator,value):
#     driver.find_element(*locator).send_keys(value)
#
# def select_items(locator,value):
#     web_el = driver.find_element(*locator)
#     s = Select(web_el)
...
# driver.get("httP://demowebshop.tricentis.com")
# driver.maximize_window()
# click_element((By.CLASS_NAME,"ico-register")) #(By.CLASS_NAME,"ico-register") ---> ("class name","ico-register")
# click_element((By.ID,"gender-male"))
# enter_text((By.ID,"FirstName"),"mohana kasi")
# enter_text((By.ID,"LastName"),"settipalli")
# enter_text((By.NAME,"Email"),"rma8@k18.com")
# enter_text((By.ID,"Passw ord"),"Mohana1995")
# enter_text((By.ID,"ConfirmPassword"),"Mohana1995")
# click_element((By.ID,"register-button"))
# click_element((By.XPATH,"//div[@class='center-2']//input[@class='button-1 register-continue-button']"))
